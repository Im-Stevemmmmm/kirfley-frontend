...
export type MeQuery = { me?: Maybe<Pick<User, 'username' | 'email' | 'password'>> };
...
export const RegisterUserDocument = gql`
  ...
  registerUser(data: {username: $username, email: $email, password: $password}) {
    successful
    error {
      field
      message
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    CheckFieldAvailabilty(variables: CheckFieldAvailabiltyQueryVariables, requestHeaders?: Headers): Promise<CheckFieldAvailabiltyQuery> {
      return withWrapper(() => client.request<CheckFieldAvailabiltyQuery>(print(CheckFieldAvailabiltyDocument), variables, requestHeaders));
    },
