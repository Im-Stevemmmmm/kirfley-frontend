...
test("confirm password input is displayed", () => {
    const { getByLabelText } = render(
        <MockedProvider>
            <SignupForm />
        </MockedProvider>
...
test("signs the user up on submit and redirects to /home", async () => {
...
test.todo("confirmation email is sent after signup");
