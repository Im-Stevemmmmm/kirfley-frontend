...
describe('footer', () => {
    ...
    describe('about column', () => {
        ...
        beforeEach(() => {
            aboutColumn = screen.getByText('About', { selector: 'li' })
                .parentElement;
        });
    ...
    describe('support column', () => {
        ...
        it('has a contact us link', () => {
            expect(supportColumn.children.item(1).textContent).toBe(
                'Contact Us'
            );
        });
    });
    ...
    describe('legal column', () => {
        ...
        beforeEach(() => {
            legalColumn = screen.getByText('Legal', { selector: 'li' })
                .parentElement;
        });
        ...
        it('has a privacy policy link', () => {
            expect(legalColumn.children.item(1).textContent).toBe(
                'Privacy Policy'
            );
        });

        it('has a cookie policy link', () => {
            expect(legalColumn.children.item(2).textContent).toBe(
                'Cookie Policy'
            );
        });
    });
